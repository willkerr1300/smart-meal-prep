...
export class Database {
    ...
    seedData(numIngredients: number) {
        ...
        for (let i = 0; i < numIngredients; i++) {
            ...
            // UX Fix: Make name cleaner. "Steamed Egg" instead of "Steamed Egg 60"
            // We only append the ID if it's a generated duplicate to keep them technically distinct but readable.
            // Actually, for display, let's just make them look nice.
            const name = isBase ? base.name : `${modifier} ${base.name}`;
            ...
            this.ingredients.set(i, {
                ...
                fat: f,
                calories: cal,
                unit: "100g" // Standard unit for realism
            });
        }
        ...
        for (let i = 0; i < 50; i++) {
            ...
            this.recipes.set(i, {
                id: i,
                name: `Meal Option ${i + 1}`, // Cleaner recipe name
